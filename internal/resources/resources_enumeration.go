...
type EnumerationResource struct {
	client *graphql.Client
}

func NewEnumerationResource() resource.Resource {
	return &EnumerationResource{}
}

func (r *EnumerationResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *EnumerationResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_enumeration"
}

func (r *EnumerationResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schemas.RateLimitingResourceSchema()
}

func (r *EnumerationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	ruleInput, err := convertEnumerationRateLimitingModelToCreateInput(ctx, data, r.client)
	if ruleInput == nil || err != nil {
		utils.AddError(ctx, &resp.Diagnostics, err)
		return
	}

	id, err := getEnumerationRateLimitingRuleId(ruleInput.Name, ctx, *r.client)
	if err != nil {
		utils.AddError(ctx, &resp.Diagnostics, err)
		return
	}
...
func (r *EnumerationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *models.RateLimitingRuleModel
	...
	response, err := getEnumerationRateLimitingRule(data.Id.ValueString(), ctx, *r.client)
	if err != nil {
		utils.AddError(ctx, &resp.Diagnostics, err)
		return
	}
...
func (r *EnumerationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *models.RateLimitingRuleModel
	resp.Diagnostics.Append(req.Plan.Get(ctx, &data)...)
	if resp.Diagnostics.HasError() {
		return
	...
	input, err := convertEnumerationRateLimitingModelToUpdateInput(ctx, data, dataState.Id.ValueString(), r.client)
	if err != nil {
...
func (r *EnumerationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *models.RateLimitingRuleModel
...
func (r *EnumerationResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	ruleName := req.ID
	id, err := getEnumerationRateLimitingRuleId(ruleName, ctx, *r.client)
	if err != nil {
		utils.AddError(ctx, &resp.Diagnostics, err)
		return
	}
	...
	response, err := getEnumerationRateLimitingRule(id, ctx, *r.client)
	if err != nil {
		utils.AddError(ctx, &resp.Diagnostics, err)
		return
	}
...
func getEnumerationRateLimitingRule(id string, ctx context.Context, r graphql.Client) (*generated.RateLimitingRuleFields, error) {
	rateLimitingfields := generated.RateLimitingRuleFields{}
	category := []*generated.RateLimitingRuleCategory{}
	enumeration := generated.RateLimitingRuleCategoryEnumeration
...
func getEnumerationRateLimitingRuleId(ruleName string, ctx context.Context, r graphql.Client) (string, error) {
	category := []*generated.RateLimitingRuleCategory{}
	enumeration := generated.RateLimitingRuleCategoryEnumeration
	category = append(category, &enumeration)
...
func convertEnumerationRateLimitingModelToCreateInput(ctx context.Context, data *models.RateLimitingRuleModel, client *graphql.Client) (*generated.InputRateLimitingRuleData, error) {
	...
	category := generated.RateLimitingRuleCategoryEnumeration
...
func convertEnumerationRateLimitingModelToUpdateInput(ctx context.Context, data *models.RateLimitingRuleModel, id string, client *graphql.Client) (*generated.InputRateLimitingRule, error) {
