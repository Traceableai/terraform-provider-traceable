...
page_title: "traceable_custom_signature_allow Resource - terraform-provider-traceable"
subcategory: ""
description: |-
  
---

# traceable_custom_signature_allow (Resource)
...
- `allow_expiry_duration` (String) Time to allow the rule (Time is seconds)
