    ...
    query:=fmt.Sprintf(`mutation {
                                    createCustomSignatureRule(
                                        create: {
                                            name: "%s"
                                            description: "%s"
                                            ruleEffect: { eventType: ALLOW, effects: [] }
                                            internal: false
                                            ruleDefinition: {
                                                labels: []
                                                clauseGroup: {
                                ...
                                `,name,description,finalReqResConditionsQuery,customSecRuleQuery,envQuery,exipiryDurationString)
...
func resourceCustomSignatureAllowUpdate(d *schema.ResourceData, meta interface{}) error {
    ...
    query:=fmt.Sprintf(`mutation {
                                ...
                                `,name,description,finalReqResConditionsQuery,customSecRuleQuery,envQuery,exipiryDurationString,id,disabled)
