...
func resourceSessionIdentificationResponseRule() *schema.Resource {
	return &schema.Resource{
		Create: resourceSessionIdentificationResponseRuleCreate,
		Read:   resourceSessionIdentificationResponseRuleRead,
		Update: resourceSessionIdentificationResponseRuleUpdate,
		Delete: resourceSessionIdentificationResponseRuleDelete,
		...
		Schema: map[string]*schema.Schema{
			...
			"session_token_details": {
				Type:        schema.TypeList,
				Description: "Details of the session token of type response",
				Required:    true,
				MaxItems:    1,
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"token_response_header": {
							Type:        schema.TypeSet,
							Description: "response header for token",
							Optional:    true,
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"token_key": {
						...
						"token_response_cookie": {
							Type:        schema.TypeSet,
							Description: "response cookie for token",
							Optional:    true,
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"token_key": {
...
func resourceSessionIdentificationResponseRuleCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceSessionIdentificationResponseRuleUpdate(d *schema.ResourceData, meta interface{}) error {
	id := d.Id()
	name := d.Get("name").(string)
	...
	`, id, name, descriptionStr, scopeStr, conditionListStr, responseAttributeKeyLocationStr, expirationTypeStr, obfuscationStr, tokenMatchConditionStr, valueProjectionsStr)
...
func resourceSessionIdentificationResponseRuleDelete(d *schema.ResourceData, meta interface{}) error {
	id := d.Id()
	...
	if !ok || !success {
		return fmt.Errorf("failed to delete Session Identification response rule")
	}
