...
func ResourceRateLimitingRuleAlert() *schema.Resource {
	return &schema.Resource{
		Create:        resourceRateLimitingRuleAlertCreate,
		Read:          resourceRateLimitingRuleAlertRead,
		Update:        resourceRateLimitingRuleAlertUpdate,
		Delete:        resourceRateLimitingRuleAlertDelete,
		CustomizeDiff: validateSchemaAlert,
...
func validateSchemaAlert(ctx context.Context, d *schema.ResourceDiff, meta interface{}) error {
...
func resourceRateLimitingRuleAlertCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceRateLimitingRuleAlertUpdate(d *schema.ResourceData, meta interface{}) error {
	name := d.Get("name").(string)
	rule_type := d.Get("rule_type").(string)
	description := d.Get("description").(string)
	environments := d.Get("environments").([]interface{})
...
func resourceRateLimitingRuleAlertDelete(d *schema.ResourceData, meta interface{}) error {
	id := d.Id()
