...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"traceable_notification_rule_protection_configuration_change": resourceNotificationRuleProtectionConfig(),
			"traceable_notification_rule_team_activity": resourceNotificationRuleTeamActivity(),
			"traceable_notification_rule_api_naming": resourceNotificationRuleApiNaming(),
			"traceable_notification_rule_api_documentation": resourceNotificationRuleApiDocumentation(),
			"traceable_notification_rule_data_collection": resourceNotificationRuleDataCollection(),
			"traceable_notification_rule_risk_scoring": resourceNotificationRuleRiskScoring(),
			"traceable_notification_rule_exclude_rule": resourceNotificationRuleExcludeRule(),
