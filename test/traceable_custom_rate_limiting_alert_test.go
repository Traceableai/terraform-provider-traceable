...
func TestRateLimitingAlertIpAddress(t *testing.T) {
	  ...
	  for _,ipaddress :=range ipaddresstc {
			...
			terraformOptions := &terraform.Options{
				TerraformDir: "../examples/resources/traceable_rate_limiting_alert",
		
						Vars: map[string]interface{}{
        "name":            "tf_automation_rl_alert_test ",
			...
			output := terraform.OutputMap(t, terraformOptions, "traceable_rate_limiting_alert")
...
func TestRateLimitingAlertIpAsn(t *testing.T) {
...
func TestRateLimitingAlertIpConnection(t *testing.T) {
...
func TestRateLimitingAlertRegions(t *testing.T) {
...
func TestRateLimitingAlertScanner(t *testing.T) {
...
func TestRateLimitingAlertEmailDomain(t *testing.T) {
...
func TestRateLimitingAlertUserAgent(t *testing.T) {
...
func TestRateLimitingAlertIpOrganisation(t *testing.T) {
...
func TestRateLimitingAlertIpLocation(t *testing.T) {
...
func TestRateLimitingAlertIpReputation(t *testing.T) {
...
func TestRateLimitingAlertIpAbuse(t *testing.T) {
...
func TestRateLimitingAlertthresholdconfigs(t *testing.T) {
...
func TestRateLimitingAlertRRSingle(t *testing.T) {
...
func TestRateLimitingAlertRRMulti(t *testing.T) {
...
func TestRateLimitingAlertAttribute(t *testing.T) {
